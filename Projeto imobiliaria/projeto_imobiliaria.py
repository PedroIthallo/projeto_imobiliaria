...
Original file is located at
    https://colab.research.google.com/drive/1zIgkibze8vS3nX9CLWKnUHJgVLOFYJz8
...
dados[['Tipo', 'Quartos', 'Valor']].head(10)
...
df.fillna(0) #substitui o valor null por 0
...
df.to_csv('dados_apartamentos.csv', index=False) #tira o index 'Umnamed'
...
dados['Possui_suite'] = dados['Suites'].apply(lambda x: 'Sim' if x > 0 else 'Não') # o 'x' equivale a quantidade de linhas presentes na coluna suite
dados.head()
